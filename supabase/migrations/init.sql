...
-- 9. ADVENTURE MODE TABELLEN (geplant, noch nicht implementiert)
-- quests, user_daily_quests, quest_completions, artifacts, character_artifacts, friend_tasks, friend_task_completions
-- Siehe Adventure-Mode-Plan im Snapshot-Kommentar unten.

-- 10. RPC: COMPLETE TASK
