...
ALTER TABLE characters ADD COLUMN IF NOT EXISTS daily_steps INTEGER DEFAULT 0;
ALTER TABLE characters ADD COLUMN IF NOT EXISTS monthly_steps INTEGER DEFAULT 0;
