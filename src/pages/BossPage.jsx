      ...
      >
        <div className="relative z-10 p-2">
          <div className="flex items-center gap-4 mb-4">
            <div className="w-16 h-16 rounded-full bg-dark-500/80 border border-gold-500/30 flex items-center justify-center text-4xl shadow-xl">
              {boss.icon}
            </div>
            <div className="flex-1">
              <h2 className="font-title text-3xl text-red-400 drop-shadow-[0_2px_4px_rgba(0,0,0,0.8)]">{boss.name}</h2>
              <p className="text-xs text-gray-300 font-bold uppercase tracking-widest drop-shadow-md">Wöchentlicher Raid-Boss</p>
            </div>
            {boss.defeated && <span className="badge bg-green-900/80 text-green-400 border border-green-500/50 text-lg py-1 px-4 animate-bounce">BESIEGT! 🎉</span>}
          </div>
